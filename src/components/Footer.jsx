            ...
            <div className="footer-brand">
              ...
              <FadeUp delay={0.4}>
                <div className="footer-newsletter">
                  ...
                  <p>Get wellness tips and updates straight to your inbox.</p>
        ...
        <FadeUp>
          <div className="footer-bottom">
            <div className="footer-bottom-content">
              <p className="copyright">© {new Date().getFullYear()} June Flint. All rights reserved.</p>
              <p className="footer-tagline-small">Made with <span className="heart">♥</span> for your wellness journey</p>
            </div>
          </div>
        </FadeUp>
      </div>
